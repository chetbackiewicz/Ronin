...
DROP TABLE IF EXISTS athlete, gym, referee, bout, competition, outcome, athlete_competition, style, gym_style, style, athlete_style CASCADE;
...
CREATE TABLE bout (
    ...
    accepted boolean,
    points int,
    CONSTRAINT PK_bout_id KEY (bout_id),
...
CREATE TABLE outcome (
    ...
    loser_id int,
    disputed boolean,
    CONSTRAINT PK_outcome_id KEY (outcome_id),
...
CREATE TABLE outcome (
    ...
    bout_id int,
    outcome_id int,
    CONSTRAINT PK_competition_id KEY (competition_id),
...
CREATE TABLE referee (
    ...
    first_name varchar,
    last_name varchar,
    CONSTRAINT PK_referee_id KEY (referee_id),
    CONSTRAINT FK_gym_id FOREIGN KEY (gym_id) REFERENCES gym(gym_id)
);
